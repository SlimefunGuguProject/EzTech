package me.ezcoins.CavernTech.Recipes.Machines;
...
import me.ezcoins.CavernTech.Core.*;
import me.ezcoins.CavernTech.Machines.Factory.*;
import me.ezcoins.CavernTech.Machines.QOL.*;
import me.ezcoins.CavernTech.CavernTech;
import me.ezcoins.CavernTech.Machines.QOL.CookieMaker;
...
public class MachineRecipes {
    ...
    public static final int COOKIE_ENERGY = 100;
    ...
    public static void setup(CavernTech plugin) {
        ...
        }).material(Material.COBBLESTONE).speed(1).energyPerTick(48).register(CavernTech.plugin);
        ...
        new MachineBlock(Groups.EzMachines, MachineSetup.INGOTEXTRACTOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{
                ...
                energyPerTick(300).register(CavernTech.plugin);
        ...
        new AdvancedProduceCollector(Groups.EzMachines, MachineSetup.AdvancedProduceCollector, RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[]{
                        null, SlimefunItems.PRODUCE_COLLECTOR, null,
                        new ItemStack(Material.BUCKET), SlimefunItems.BIG_CAPACITOR, new ItemStack(Material.BUCKET),
                        SlimefunItems.ALUMINUM_BRASS_INGOT, MaterialsSetup.MACHINE_MOTOR, SlimefunItems.ALUMINUM_BRASS_INGOT})
                .setCapacity(256)
    ...
    public static final class RandomizedItemStack extends ItemStack {
