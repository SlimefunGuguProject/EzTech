...
public class MachineSetup {
    ...
    public static final SlimefunItemStack ExtremeFreezer = new SlimefunItemStack(
            ...
            "&bExtreme Freezer",
            "",
            "&7Turns everything into a frozen state",
            "",
            MachineLore.energyPerSecond(60),
            MachineLore.energyBuffer(360)
    );
    ...
    public static final SlimefunItemStack AdvancedProduceCollector = new SlimefunItemStack("ADVANCED_PRODUCE_COLLECTOR",
            Material.HAY_BLOCK,
            "&eAdvanced Produce Collector",
            "",
            "&7Collects produces from a collection of nearby animals",
            "",
