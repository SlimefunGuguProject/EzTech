...
import me.ezcoins.CavernTech.Core.EzRecipeTypes;
...
public final class MobData {
    ...
    public static void setup(CavernTech plugin) {
        ...
        if (CavernTech.environment() == Environment.TESTING) {
            return;
        }
        ...
        new MobDataCard(ELDER_GUARDIAN, MobDataTier.MINI_BOSS, new ItemStack[] {
                ...
                .addDrop(Material.LAPIS_LAZULI, 8, 1)
                .register(plugin);
        ...
        new MobDataCard(ENDER_DRAGON, MobDataTier.BOSS, new ItemStack[] {
                ...
                .addDrop(Material.ENDER_EYE, 6, 1)
                .addDrop(Material.OBSIDIAN, 16, 5)
                .register(plugin);
