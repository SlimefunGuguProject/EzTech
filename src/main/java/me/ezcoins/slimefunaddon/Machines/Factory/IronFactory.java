...
public class IronFactory extends AContainer implements RecipeDisplayItem{
    ...
    public IronFactory(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected void registerDefaultRecipes() {
        if (useVanillaRatios.getValue()) {
            registerRecipe(4, new ItemStack[] { new ItemStack(Material.COBBLESTONE,16) }, new ItemStack[] { new ItemStack(Material.IRON_INGOT, 8) });
