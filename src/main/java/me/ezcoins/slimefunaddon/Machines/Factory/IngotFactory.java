...
public class IngotFactory extends AContainer implements RecipeDisplayItem{
    ...
    private final ItemStack[] Log = new ItemStack[] {
            SlimefunItems.GOLD_DUST,
    };


    public IngotFactory(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
